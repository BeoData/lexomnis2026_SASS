    ...
    <AuthenticatedLayout>
        <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <div class="px-4 py-6 sm:px-0">
                <div class="mb-6">
                    <Link
                        :href="route('feature-flags.show', featureFlag.id)"
                        class="text-blue-600 hover:text-blue-800 text-sm"
                    >
                        ← Back to Feature Flag
                    </Link>
                </div>
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            ...
                            >
                                ...
                                <span v-else>Update Feature Flag</span>
                            </button>
                        </div>
                    </form>
                </div>
...
const form = useForm({
    ...
    key: props.featureFlag.key || '',
    description: props.featureFlag.description || '',
    is_active: props.featureFlag.enabled ?? props.featureFlag.is_active ?? true,
    tenant_id: props.featureFlag.firm_id || props.featureFlag.tenant_id || null,
    environment: props.featureFlag.environment || 'all',
});
...
const submit = () => {
    ...
    form.put(route('feature-flags.update', props.featureFlag.id));
};
</script>
