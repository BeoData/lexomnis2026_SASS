            ...
            <form method="POST" action="{{ route('plans.update', $plan['id']) }}">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input id="plan_key" name="plan_key" type="text" required value="{{ old('plan_key', $plan['plan_key'] ?? '') }}" placeholder="easystart, essentials, advanced, expand" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('plan_key') border-red-300 @enderror" />
                    ...
                    <div>
                        <label class="flex items-center">
                            <input name="is_visible_to_customers" type="checkbox" value="1" {{ old('is_visible_to_customers', $plan['is_visible_to_customers'] ?? true) ? 'checked' : '' }} class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
