    ...
    <div class="px-4 py-6 sm:px-0">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div>
                        ...
                        <div class="mt-4 flex gap-4 text-sm">
                            <span class="text-green-600">
                                Active: {{ $stats['tenants']['active'] ?? 0 }}
                            </span>
                            <span class="text-yellow-600">
                                Trial: {{ $stats['tenants']['trial'] ?? 0 }}
                            </span>
                            <span class="text-red-600">
                                Suspended: {{ $stats['tenants']['suspended'] ?? 0 }}
                            </span>
                        </div>
                    </div>
                ...
                <a href="{{ route('tenants.index') }}" class="mt-4 inline-block text-sm text-blue-600 hover:text-blue-800">
                    View all tenants →
                </a>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <a href="{{ route('users.index') }}" class="mt-4 inline-block text-sm text-blue-600 hover:text-blue-800">
                    View all users →
                </a>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <a href="{{ route('subscriptions.index') }}" class="mt-4 inline-block text-sm text-blue-600 hover:text-blue-800">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <a href="{{ route('plans.index') }}" class="mt-4 inline-block text-sm text-blue-600 hover:text-blue-800">
                    View all plans →
                </a>
            </div>
        </div>
        ...
        <div class="mb-8">
            <div class="bg-white rounded-lg shadow">
                            ...
                            @foreach($recentActivity as $activity)
                                <div class="flex items-start gap-4 pb-4 border-b border-gray-200 last:border-0">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="text-sm font-medium text-gray-900">{{ $activity['description'] ?? $activity['action'] ?? 'N/A' }}</p>
                                        <p class="text-xs text-gray-500 mt-1">
                                            {{ \Carbon\Carbon::parse($activity['created_at'] ?? '')->format('M d, Y h:i A') }}
                                            @if(isset($activity['user']))
                                                <span class="ml-2">by {{ $activity['user']['name'] ?? $activity['user']['email'] ?? '' }}</span>
                                            @endif
                                        </p>
                                    </div>
                                </div>
                ...
                <div class="px-6 py-4 border-t border-gray-200 bg-gray-50">
                    <a href="{{ route('audit-logs.index') }}" class="text-sm text-blue-600 hover:text-blue-800">
                        View all audit logs →
                    </a>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
                <h2 class="text-xl font-semibold mb-2 text-gray-900">Create Tenant</h2>
                <p class="text-gray-600">Add a new tenant to the system</p>
            </a>
            <a
                href="{{ route('plans.create') }}"
                class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow"
            >
                <h2 class="text-xl font-semibold mb-2 text-gray-900">Create Plan</h2>
                <p class="text-gray-600">Create a new subscription plan</p>
            </a>
            <a
                href="{{ route('feature-flags.create') }}"
                class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow"
            >
                <h2 class="text-xl font-semibold mb-2 text-gray-900">Create Feature Flag</h2>
                <p class="text-gray-600">Add a new feature flag</p>
            </a>
        </div>
    </div>
</div>
