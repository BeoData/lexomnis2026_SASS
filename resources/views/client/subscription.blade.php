                ...
                <table class="w-full text-left text-sm border-collapse">
                    <thead class="bg-gray-50/50 text-gray-400 font-bold border-b border-gray-100">
                        <tr>
                            ...
                            <th class="p-4 uppercase tracking-widest text-xs text-right">Status</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50">
                        @if(!empty($invoices))
                            ...
                            <tr class="hover:bg-gray-50/30 transition-colors">
                                ...
                                <td class="p-4 text-gray-600">Pretplata za {{ $invoice['description'] ?? 'plan' }}</td>
                                <td class="p-4 font-bold text-gray-900">€{{ $invoice['amount'] }}</td>
                                <td class="p-4 text-right">
                                    <span class="badge {{ $invoice['status'] == 'completed' ? 'badge-green' : 'badge-yellow' }}">
                        ...
                        @else
                            <tr>
                                <td colspan="4" class="p-8 text-center text-gray-500 italic">Još uvek nema zabeleženih plaćanja.</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
